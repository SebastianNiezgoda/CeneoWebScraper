...
def product(product_code):
    return render_template('product.html', product_code=product_code, opinions=opinions.to_html(headers=True, classes='table table-striped table-successs', table_id='opinions'))
